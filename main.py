...
def main():
    ...
    url="https://www.nike.com/kr/ko_kr/t/men/fw/nike-sportswear/CQ0076-500/lkrc67/acg-zoom-terra-zaherra"
    shoes_size="260"
...
# driver.window_handle #获取所有窗口的handle，返回list列表
# driver.switch_to.window(handle) #切换到对应的窗口
# driver.close() #关闭当前窗口

# WebDriverWait(driver, 5).until(EC.visibility_of_element_located((By.XPATH, "//*[@id='kakao-sync-modal-login']/div/div/div")))
# 等待XPATH元素可见
# 等待XPATH元素不可见
