    ...
    def robot_start(self,kakao_phone,kakao_birth):
        ...
        while 1:
            ...
            if now > self.start_time:
                ...
                # sleep(1)
                Select(self.driver.find_element_by_id("selectSize")).select_by_index(1).click()
                # WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.XPATH,"//ul[@class='select-body']//a[@data-value='42']/span"))) self.driver.find_element_by_xpath("//ul[@class='select-body']//a[@data-value='42']/span").click()
                # # sleep(1)
                # WebDriverWait(self.driver, 5).until(EC.visibility_of_element_located((By.XPATH,"//span[@class='btn-buy]")))
                # self.driver.find_element_by_xpath("//span[@class='btn-buy']").click()
                # self.driver.find_element_by_xpath(u"(.//*[normalize-space(text()) and normalize-space(.)='사이즈 선택'])[2]/following::span[1]").click()
                time3 = time()
